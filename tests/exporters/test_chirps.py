...
class TestCHIRPSExporter:
    ...
    def test_get_filenames(self, request_patch, monkeypatch, tmp_path):
        ...
        expected_response = '-rw-r--r--    1 31094    31111     4172329 Feb 01  2015 ' \
        ...
        expected_filenames = ['chirps-v2.0.1981.01.1.tif.gz', 'chirps-v2.0.1981.01.2.tif.gz',
                              'chirps-v2.0.1981.01.3.tif.gz', 'chirps-v2.0.1981.01.4.tif.gz',
                              'chirps-v2.0.1981.01.5.tif.gz', 'chirps-v2.0.1981.01.6.tif.gz',
                              'chirps-v2.0.1981.02.1.tif.gz', 'chirps-v2.0.1981.02.2.tif.gz',
                              'chirps-v2.0.1981.02.3.tif.gz', 'chirps-v2.0.1981.02.4.tif.gz',
        ...
        assert request_patch.call_args[0][0] == self.africa_url, \
