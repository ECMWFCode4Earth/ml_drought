...
all_hrs = np.array(
    [hrly_6 + ((day-1) * 24) for day in range(1, 215 + 1)]
)
...
valid_datasets = ['seasonal-original-single-levels',
    ...
    'seasonal-original-single-levels':
        {
            ...
            'variable': ['10m_u_component_of_wind', '10m_v_component_of_wind',
                ...
                'east_west_surface_stress_rate_of_accumulation', 'evaporation',
                'maximum_2m_temperature_in_the_last_24_hours', 'mean_sea_level_pressure',
                'minimum_2m_temperature_in_the_last_24_hours',
                'north_south_surface_stress_rate_of_accumulation',
                'runoff', 'sea_ice_cover', 'sea_surface_temperature', 'snow_density',
                ...
                'top_solar_radiation', 'top_thermal_radiation', 'total_cloud_cover',
                'total_precipitation'],
            'pressure_level': None,
            'product_type': None,
            'leadtime_month': None,
    ...
    'seasonal-original-pressure-levels':
        {
            ...
            'pressure_level': ['10', '30', '50', '100', '200', '300', '400', '500', '700', '850', '925'],
            'product_type': None,
            'leadtime_month': None,
    ...
    'seasonal-monthly-single-levels':
        {
            ...
            'variable': ['10m_u_component_of_wind', '10m_v_component_of_wind',
                ...
                'total_precipitation'],
            'pressure_level': None,
            'product_type': ['ensemble_mean', 'hindcast_climate_mean', 'monthly_maximum',
